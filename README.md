...
**EN** · AI Knowledge Bank is a living knowledge system. It helps people turn scattered AI practices into reusable standards through branching, validation, discussion, voting, and emergence.

**中文** · AI Knowledge Bank 不是静态课程站，也不是普通 Prompt 仓库。它把知识看作一个持续演化的网络：用户贡献实践经验，社区在真实场景中验证，高价值分支再合并为新的公共标准。
