...
const dictionaries = {
  zh: {
    ...
    loading: '正在读取已发布条目…',
    empty: '这里还没有已发布条目',
    searchPlaceholder: '筛选本页条目',
    sourceAll: '全部数据来源',
    trustAll: '全部可信度',
    liveSource: '实时数据',
    trust: '可信度',
    resultLoading: '正在读取条目',
    resultUnavailable: '暂时无法读取条目，请稍后再试',
    resultEmpty: '这里还没有已发布条目',
    resultNoMatch: '没有符合筛选条件的条目',
    dispatchKicker: '跨库查找',
    dispatchTitle: '从一个问题，找到解释、路径和证据。',
    dispatchCopy: '描述你的目标，查看解释、执行路径和真实案例。',
    dispatchPlaceholder: '例如：跨境营销团队要优化 AI 本地化 SOP',
    dispatchRun: '查找三层结果',
    dispatchRunning: '正在查找知识、工具和案例…',
    ...
    pageCopyKnowledge: '这里保存可解释的原则、判断框架和边界条件。每个条目都说明适用场景、证据来源和复审条件。',
    sectionTitleKnowledge: '可解释的判断条目',
    sectionCopyKnowledge: '这些知识条目构成跨库查找的解释层。',
    ...
    pageCopyTools: '这里组织 Agent、Prompt、工作流和人工确认点。每个方法都说明输入、步骤、质量标准和复用边界。',
    sectionTitleTools: '可执行的方法',
    sectionCopyTools: '这些方法可以组合成面向具体目标的执行路径。',
    ...
    sectionCopyCases: '这些案例构成跨库查找的证据层，让建议可以被核对。',
    insightTitleCases: '案例如何成为证据',
    insightCopyCases: '保留上下文、过程、结果、限制和人工复核，才有迁移价值。',
    pageKickerCommunity: '社区 / Community',
    pageTitleCommunity: '知识因真实使用而可信。',
    pageCopyCommunity: '真实使用、复用、分叉、合并、争议和衰减共同构成演化信号。社区帮助证据充分的方法形成共同标准。',
    sectionTitleCommunity: '等待进一步验证的方法',
    sectionCopyCommunity: '这里优先展示适合继续使用、质疑和补充证据的方法。',
    insightTitleCommunity: '实践如何形成共同标准',
    insightCopyCommunity: '先提交证据，再由不同场景复用和分叉；只有信号足够强，分支才会合并。',
    runValidation: '验证当前条目',
    validationReady: '选择一个条目并提交你的真实使用结果。',
    validationRunning: '正在验证会话并提交信号...',
    validationPersisted: '验证已记录，并计入条目的社区信号。',
    validationQueued: '演示验证已在本地完成，不会写入数据库。',
    validationFailed: '暂时无法提交验证，请稍后再试。',
    validationAuthRequired: '登录后才能验证真实条目；演示条目仍可在本地体验。',
    panelTitleCommunity: '提交使用结果',
    panelCopyCommunity: '真实条目会以当前登录用户的身份写入；演示条目只在本地模拟，不会写入数据库。',
  ...
  en: {
    ...
    backHome: 'Home',
    startLearning: 'Cross-vault search',
    toggle: '中',
    ...
    resultEmpty: 'No entries are available',
    resultNoMatch: 'No entries match the filters',
    dispatchKicker: 'CROSS-VAULT SEARCH',
    dispatchTitle: 'Find the reasoning, path, and evidence behind a method',
    dispatchCopy: 'Describe a goal to see the reasoning, execution path, and case evidence behind it.',
    dispatchPlaceholder: 'Example: improve an AI localization SOP for a cross-border marketing team',
    dispatchRun: 'Find across vaults',
    dispatchRunning: 'Searching knowledge, tools, and cases…',
    dispatchReady: 'Describe a problem to start a cross-vault search',
    ...
    pageCopyKnowledge: 'This vault stores explainable principles, decision frames, and boundary conditions. Each entry states where it applies, what supports it, and when it needs review.',
    sectionTitleKnowledge: 'Explainable decision entries',
    sectionCopyKnowledge: 'These knowledge entries form the explanation layer of cross-vault search.',
    ...
    pageCopyTools: 'This vault organizes agents, prompts, workflows, and human checkpoints. Each method explains its inputs, steps, quality bars, and reuse boundaries.',
    sectionTitleTools: 'Executable methods',
    sectionCopyTools: 'These methods combine into execution paths for a concrete goal.',
    ...
    sectionCopyCases: 'These cases ground cross-vault search in outcomes that can be checked.',
    ...
    pageTitleCommunity: 'Knowledge earns trust through real use.',
    pageCopyCommunity: 'Real use, reuse, forks, merges, disputes, and decay become evolution signals. Community helps well-supported methods become shared standards.',
    sectionTitleCommunity: 'Methods awaiting further evidence',
    sectionCopyCommunity: 'This view surfaces methods ready to be used, challenged, or supported with more evidence.',
    insightTitleCommunity: 'How practice becomes a shared standard',
    insightCopyCommunity: 'Submit evidence, reuse and fork it across contexts, and merge only when the signal is strong enough.',
    runValidation: 'Validate this entry',
    validationReady: 'Choose an entry and submit a result from real use.',
    validationRunning: 'Verifying your session and submitting the signal...',
    validationPersisted: 'Validation recorded and added to the entry’s community signals.',
    ...
    validationAuthRequired: 'Sign in to validate real entries; demo entries remain available locally.',
    panelTitleCommunity: 'Submit a result',
    panelCopyCommunity: 'Real entries are written with the signed-in user’s session. Demo entries are simulated locally and never written to the database.',
...
const insights = {
  ...
  en: {
    knowledge: [
      ...
      ['Review conditions', 'Keep sources, applicable contexts, and the point when the entry needs review.']
    ],
    tools: [
...
const communitySignals = {
  zh: [
    ['验证', '提交真实结果、证据和置信度，为条目增加可追踪信号。'],
    ['使用', '记录一次具体采用，帮助系统识别真正可复用的方法。'],
    ['分叉', '为新行业、角色或约束建立清楚的场景版本。'],
    ['合并', '只有分支的验证足够强，才提升为新的共享版本。'],
    ['争议', '标记证据不足、过期或高风险内容，阻止错误经验进入共同标准。'],
    ['衰减', '让过时条目自然降权，避免旧方法长期占据推荐位置。']
  ],
  en: [
    ...
    ['Decay', 'Lower the weight of outdated entries so old methods do not dominate.']
  ]
};
...
function updateResultStatus(shown, total) {
  ...
  resultStatus.textContent = currentLanguage === 'zh'
    ? `显示 ${shown}/${total} 个条目 · ${dict.liveSource}: ${sourceName}`
    : `Showing ${shown}/${total} entries · ${dict.liveSource}: ${sourceName}`;
}
