...
export const translations = {
  zh: {
    ...
    // Dashboard
    'dashboard.pageTitle': '验证与贡献 | AI Knowledge Bank',
    'dashboard.description': '登录后提交真实使用结果，并查看信誉、徽章和通知。',
    'dashboard.languageLabel': '切换语言',
    'dashboard.loading': '正在读取贡献记录...',
    'dashboard.authRequired.title': '登录后继续验证与贡献',
    'dashboard.authRequired.copy': '使用 GitHub 登录，提交使用结果并查看信誉、徽章和通知。',
    ...
    'dashboard.activity.empty': '还没有使用结果。先提交一次真实结果。',
  ...
  en: {
    ...
    // Dispatch
    'dispatch.title': 'Cross-vault search',
    'dispatch.placeholder': 'Describe your scenario or question...',
    'dispatch.button': 'Find',
    'dispatch.loading': 'Searching...',
    ...
    // Dashboard
    'dashboard.pageTitle': 'Validate and contribute | AI Knowledge Bank',
    'dashboard.description': 'Sign in to submit real-use results and review your reputation, badges, and notifications.',
    ...
    'dashboard.authRequired.copy': 'Sign in with GitHub to submit results and review your reputation, badges, and notifications.',
    ...
    'dashboard.activity.empty': 'No results yet. Start by submitting one real outcome.',
